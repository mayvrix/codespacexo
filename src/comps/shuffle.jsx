...
const baseTw = 'inline-block whitespace-normal break-words will-change-transform uppercase leading-none text-[2rem] sm:text-[2.5rem] md:text-[3rem] lg:text-[3.5rem] xl:text-[4rem]';
