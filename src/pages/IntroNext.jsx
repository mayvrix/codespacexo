...
import ColorBends from "../comps/bends"; // ✅ Keeping consistent path with your project structure
...
export default function IntroNext() {
    ...
    <div className="w-full bg-black text-white overflow-hidden">
      ...
      <section className="w-full h-screen flex flex-col md:flex-row items-center justify-center relative">
        ...
        <div className="w-full md:w-[35%] h-1/2 md:h-full flex flex-col items-center md:items-start justify-center text-center md:text-right px-6 md:px-12">
          ...
          <p className="text-lg md:text-2xl text-white/70 max-w-xl font-doto">
            Effortlessly organize your workspace — just drag and drop your code
            files, projects, or entire folders to start building instantly.
          </p>
        </div>
      </section>
      ...
      <section className="w-full h-screen flex flex-col md:flex-row items-center justify-center relative">
        ...
        <div className="order-2 md:order-1 w-full md:w-[35%] h-1/2 md:h-full flex flex-col items-center md:items-end justify-center text-center md:text-left px-6 md:px-12">
          ...
          <p className="text-lg md:text-2xl text-white/70 max-w-xl font-doto">
            Publish your files for everyone to access — no login needed. You can
            also log in to download your code files or even the entire project
            as a ZIP with a single click.
          </p>
        </div>
      </section>
      ...
      <section className="w-full h-screen flex flex-col md:flex-row items-center justify-center relative">
        ...
        <div className="w-full md:w-[35%] h-1/2 md:h-full flex flex-col items-center md:items-start justify-center text-center md:text-right px-6 md:px-12">
          ...
          <p className="text-lg md:text-2xl text-white/70 max-w-xl font-doto leading-relaxed">
            ...
            <span className="text-white font-semibold">PDFs</span> (max{" "}
            <span className="text-white font-semibold">3&nbsp;MB</span> each)
            and <span className="text-white font-semibold">images</span> (max{" "}
            <span className="text-white font-semibold">1&nbsp;MB</span> per
            file). Instantly preview your documents and pictures — right inside
            the website with our built-in PDF & image viewer.
          </p>
        </div>
      </section>
      ...
      <section className="w-full h-screen flex flex-col md:flex-row items-center justify-center relative">
        ...
        <div className="order-2 md:order-1 w-full md:w-[30%] h-1/2 md:h-full flex flex-col items-center md:items-end justify-center text-center md:text-left px-6 md:px-12">
          ...
          <p className="text-lg md:text-2xl text-white/70 max-w-xl font-doto">
            Write or paste your code and save it instantly — no setup, no delay.
            Perfect for quick snippets, ideas, or debugging notes you can revisit
            anytime.
          </p>
        </div>
      </section>
      ...
      {/* ---------- PAGE 5 ---------- */}
      <section className="w-full h-screen flex flex-col items-center justify-center text-center px-6 md:px-12 relative">
        {/* ✅ FIX: Background Layer (Removed -z-10, just placed absolutely behind content) */}
       <div className="absolute inset-0 w-full h-full opacity-80"> {/* Added opacity-90 */}
  <ColorBends
  ...
  />
        ...
        {/* ✅ FIX: Content Layer (Relative + z-10 ensures it sits ON TOP of background) */}
        <div className="relative z-10 w-full flex flex-col items-center">
          ...
          <p className="text-lg md:text-2xl text-white/70 font-doto max-w-2xl mb-6">
            Explore and try out{" "}
            <span className="text-white/90 font-semibold">CODESPACEXO</span> —
            we’re still in beta, so your feedback and bug reports help us make
...
<div className="flex flex-col md:flex-row items-center justify-center gap-4 mb-10 w-full max-w-xs md:max-w-none">
  ...
  <button
    ...
    className="font-doto font-bold w-full md:w-auto px-12 py-3 md:px-20 md:py-3 rounded-full bg-gray-100 text-black text-xl transition border border-transparent hover:bg-transparent hover:text-white hover:border-white"
  >
    What's New?
  </button>
